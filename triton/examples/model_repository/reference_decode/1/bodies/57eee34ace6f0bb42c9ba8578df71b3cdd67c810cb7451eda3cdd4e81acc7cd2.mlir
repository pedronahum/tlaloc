module {
  func.func @main(%0: tensor<4x1xi32>, %1: tensor<4x1xi32>, %2: tensor<4x2xi32>, %3: tensor<4xi32>, %4: tensor<4xi32>, %5: tensor<6x2x2x2xf32>, %6: tensor<6x2x2x2xf32>) -> (tensor<4x1x11xf32>, tensor<6x2x2x2xf32>, tensor<6x2x2x2xf32>) {
    ...
    %s39 = stablehlo.dot_general %s38, %s35, batching_dims = [0, 1] x [0, 2], contracting_dims = [3] x [3] : (tensor<4x2x2x2xf32>, tensor<4x4x2x2xf32>) -> tensor<4x2x2x4xf32>
    ...
    %s58 = stablehlo.dot_general %s57, %s37, batching_dims = [0, 1] x [0, 2], contracting_dims = [3] x [1] : (tensor<4x2x2x4xf32>, tensor<4x4x2x2xf32>) -> tensor<4x2x2x2xf32>
