...
The suite has **2,653** automated tests: 2,531 that `./gradlew test` runs, and 122
...
2,531 were counted in a clean-room `./gradlew test --rerun-tasks` with 0 failures.
