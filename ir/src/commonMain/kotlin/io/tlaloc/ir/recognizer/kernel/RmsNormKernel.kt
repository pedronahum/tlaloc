...
/**
 * RMS-norm kernel selector for the **KPTX tier**:
 ...
 * typed-FFI convention ([KernelDescriptor.typedFfi]). The kernel's signature is positional
 ...
 * pipeline (tests and benchmarks pass an explicit registry).
 */
